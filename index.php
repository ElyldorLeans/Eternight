...
$webpage->appendContent(<<<HTML
        <div class="container" style="margin-top: 20px">
            <p>Le projet Eternight est un projet réalisé dans le cadre de l'UV NF28. Il a pour but de servir d'aide lors de jeux Loup Garou nuit permanente organisés par l'association UTCéenne Le Coin du Joueur.
            Un à propos digne de ce nom est encore en construction.</p>
            <!-- DEADLINE LE 19 JUIN
            <h2>Objectifs</h2>
